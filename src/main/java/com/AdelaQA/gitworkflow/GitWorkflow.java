package com.AdelaQA.gitworkflow;
...
public class GitWorkflow {
    public static void main(String[] args) {
        ...
        String step5 = "Add your changes that related ti the task";
        ...
        String step10 = "Create a pull request from origin/new_branch_name info origin/master";
        ...
        String step14 = "In case of a commit amend then a git force should be performed in order to update the remote branch and existing Pull Request";
        String step15 = "After that, the origin/master contains the latest changes and the origin/new_branch_name can be deleted";
        String step16 = "Do not forget that locally you are still on the new_branch_name, it is good to move back to master";
        String step17 = "However, the local master branch does not have the latest changes, therefor perform a git fetch and git pull";
