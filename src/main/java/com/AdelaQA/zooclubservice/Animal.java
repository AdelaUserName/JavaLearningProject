...
public abstract class Animal {
    ...
    //Metoda getName este de tip public si returneaza valoarea numelui pe care il are animalul
    public String getName() {
        return name;
    }

    //Metoda abstracta eat() nu are implementare, aeasta va fi facuta in clasele copil
